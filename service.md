...
## About Service Learning for Data Science

This is an optional Service Learning component to this course that satisfies a [Tier I or Tier II Service Learning Requirement](https://cps.tulane.edu/).  This is a small section with and participation is **hard capped at 10**, if there is no room on the [Registrar's Website](https://classschedule.tulane.edu/Search.aspx), *there is no room*.

The aim of the service learning component of this course is twofold:
1. To encourage students to apply their data science skills to local issues and 
2. To deeply think and engage with where data comes from, why it is collected, and who data centric systems may affect.  
